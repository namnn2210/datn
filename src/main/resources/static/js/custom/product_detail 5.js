            ...
            $.ajax({
                ...
                success: function (resp) {
                    if (resp.length === 0) {
                        ...
                        } else if (window.location.href.toString().includes("lang=vi")) {
                            swal({
                                title: "Cảm ơn!",
                        ...
                        for (var i in resp.cartItem) {
                            ...
                            cartButton += '<a th:text="#{label.view.cart}" href="/cart/detail" class="flex-c-m size1 bg1 bo-rad-20 hov1 s-text1 trans-0-4">';
                            if (window.location.href.toString().includes("lang=en")) {
